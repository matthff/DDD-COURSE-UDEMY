...
namespace DDD_Api_Test.PostalCodeControllerTest.GETBYZIP
{
    public class TestOkResult
    {
        ...
        public async Task MustReturnBadRequestResult()
        {
            ...
            _serviceMock.Setup(m => m.GetByPostalCode(It.IsAny<string>())).ReturnsAsync(
                new PostalCodeDTO
                {
                    Id = Guid.NewGuid(),
            ...
            var result = await _controller.GetByPostalCode(postalCode);
